    ...
    <form onSubmit={formik.handleSubmit} className="flex justify-center">
      <div className="w-full max-w-md p-4 rounded-md shadow sm:p-8 bg-gray-50 text-gray-800">
        ...
        <div className="space-y-8 ng-untouched ng-pristine ng-valid">
          ...
          <button
            type="submit"
            className="w-full bg-rose-500 hover:bg-rose-600 px-8 py-3 font-semibold rounded-md text-gray-50"
          >
            Đăng nhập
          </button>
        </div>
        ...
        <div className="flex items-center w-full my-4">
          ...
          <p className="px-3 text-gray-600">HOẶC</p>
          <hr className="w-full text-gray-600" />
        </div>

        <p className="text-sm text-center text-gray-600">
          Bạn chưa có tài khoản?
          <NavLink to="/register" className="focus:underline hover:underline">
            Đăng ký tại đây
          </NavLink>
        </p>
