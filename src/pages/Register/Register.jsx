    ...
    <div className="container bg-gray-100">
      <div className="flex justify-center">
        <div className="px-8 py-6 mx-4 my-4 text-left bg-white shadow-lg md:w-1/3 lg:w-1/3 sm:w-1/3">
          <h3 className="text-2xl font-bold text-center text-rose-500">
            ĐĂNG KÝ
          </h3>
          <Formik
            initialValues={{
              ...
              <Form action="">
                <div className="mt-4">
                    ...
                    <label className="block">
                      ...
                      <label>
                        <Field
                          ...
                          name="name"
                          placeholder="Họ tên"
                          className="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-rose-600"
                    ...
                    <div>
                      <div className="flex items-center mb-4">
                        <Field
                          ...
                          name="gender"
                          onChange={formikProps.handleChange}
                          className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-rose-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                        />
                        <label
                  ...
                  <div className="flex">
                    <button
                      type="submit"
                      className="w-full px-6 py-2 mt-4 text-white bg-rose-500 rounded-lg hover:bg-rose-700"
                    >
                      Đăng ký
                    </button>
                  </div>
                  ...
                  <div className="text-grey-dark mt-6">
                    Đã có tài khoản?
                    <NavLink
                      className="no-underline border-b border-blue text-rose-500 hover:text-rose-700"
                      to="/login"
                    >
                      Log in
                    </NavLink>
